...
LUA_EXPORT_VIEW_PROPERTY(a_flingSpeed, "mil_setFlingSpeed:", "mil_flingSpeed" , MLNScrollView)
LUA_EXPORT_VIEW_PROPERTY(i_pagingEnabled, "mil_setPagingEnable:", "mil_pagingEnabled" , MLNScrollView)
