...
- (void)http:(MLNHttp *)http get:(NSString *)urlString params:(NSDictionary *)params completionHandler:(void (^)(BOOL, NSDictionary *, NSDictionary *))completionHandler {
    ...
    if ([urlString hasPrefix:@"https://www.apiopen.top/femaleNameApi"]) {
        NSString *messagePath = [[NSBundle mainBundle] pathForResource:@"config_data/message.json" ofType:nil];
        ...
        NSString *musicRankPath = [[NSBundle mainBundle] pathForResource:@"config_data/musicRank.json" ofType:nil];
        ...
        NSString *fashionlistPath = [[NSBundle mainBundle] pathForResource:@"config_data/fashion.json" ofType:nil];
